...
public void draw()
{
  ...
  orientation.x += cos(radians(camAngle)) * (orientation.y+cols/2) - sin(radians(camAngle)) * (orientation.x+rows/2) - cols/2;
  orientation.y += sin(radians(camAngle)) * (orientation.y+cols/2) + cos(radians(camAngle)) * (orientation.x+rows/2) - rows/2;
